<%--
 ...
 Date        : 19.10.2017
 Goal        : page which is responsable for a update page  
 -----------------------------------------------------------------------------------
                              ...
                              <form role="form" method="post">
                                 <div class="box-body">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" id="inputTitle" name="inputTitle" value="${book.title}">
                                    </div>
                                    <div class="form-group">
                                       <label>Summary</label>                                    
                                       <input class="form-control" rows="3" name="inputSummary" value="${book.summary}" >
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" id="inputAuthor" name="inputAuthor" value="${book.author}">
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <div class="input-group">
                                          ...
                                          <input type="text" class="form-control" name="inputReleaseDate"data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" value="${book.releaseDate}">
                                       </div>
                                       <!-- /.input group -->
                                    </div>
                                    <div class="form-group">
                                       ...
                                       <input type="number" class="form-control" id="inputNbPages" name="inputNbPages"  value="${book.nbPages}">
                                    </div>
                                 </div>
                                 <!-- /.box-body -->
